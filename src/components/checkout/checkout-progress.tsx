...
const STEPS = [
  ...
  { id: "success", label: "Confirmation", href: "/checkout/success" },
] as const;
          ...
          return (
            <li key={step.id} className="flex items-center gap-2 sm:gap-4">
              <div className="flex flex-col items-center gap-1.5 min-w-[4.5rem] sm:min-w-[5.5rem]">
                ...
                <span
                  className={cn(
                    "text-[10px] sm:text-xs uppercase tracking-wider text-center",
              ...
              {index < STEPS.length - 1 && (
                <div
                  className={cn(
                    "hidden sm:block h-px w-8 md:w-16 mb-5 transition-colors",
