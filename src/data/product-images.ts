...
export const PRODUCT_IMAGE_BY_COLOR: Record<string, string> = {
  ...
  "LT Green": `${PRODUCT_IMAGE_BASE_URL}/LTGreen.png`,
  Plum: `${PRODUCT_IMAGE_BASE_URL}/plum.png`,
  "P.T Blue": `${PRODUCT_IMAGE_BASE_URL}/PTBlue.png`,
  Burgundy: `${PRODUCT_IMAGE_BASE_URL}/Burgandry.jpg`,
  "Dusty Rose": `${PRODUCT_IMAGE_BASE_URL}/dustyRose.jpg`,
  Brown: `${PRODUCT_IMAGE_BASE_URL}/brown.png`,
  ...
  "Park Petrol": `${PRODUCT_IMAGE_BASE_URL}/parkPetrol.png`,
